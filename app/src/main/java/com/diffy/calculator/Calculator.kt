...
import com.diffy.calculator.ui.theme.LightGray
import com.diffy.calculator.ui.theme.Orange
...
fun Calculator(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = state.number + (state.operations?.symbol ?: "") + state.number2,
            ...
            Row (
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)
                        .weight(1f),
                    onClick = { onAction(CalculatorActions.Opertaions(CalculatorOperations.Divide)) }
                )
            }
            Row (
                modifier = Modifier.fillMaxWidth(),
                ...
                modifier = Modifier
                    ...
                    .aspectRatio(1f)
                    .weight(1f),
                onClick = { onAction(CalculatorActions.Opertaions(CalculatorOperations.Multiply)) }
                )
            }
            Row (
                modifier = Modifier.fillMaxWidth(),
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)
                        .weight(1f),
                    onClick = { onAction(CalculatorActions.Opertaions(CalculatorOperations.Substract)) }
                )
            }
            Row (
                modifier = Modifier.fillMaxWidth(),
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)
                        .weight(1f),
                    onClick = { onAction(CalculatorActions.Opertaions(CalculatorOperations.Add)) }
                )
            }
            Row (
                modifier = Modifier.fillMaxWidth(),
